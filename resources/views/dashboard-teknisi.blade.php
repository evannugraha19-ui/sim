    ...
    <div class="flex min-h-screen bg-gradient-to-br from-gray-800 via-amber-950 to-gray-800 text-gray-100">
        ...
        <main class="flex-1 p-8 bg-gray-900 text-gray-100 overflow-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-amber-200/70">Selamat datang di sistem maintenance mesin</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                ...
                <div
                    ...
                    <p class="text-3xl font-bold text-amber-400">{{ $pendingCount ?? 0 }}</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-3xl font-bold text-yellow-400">{{ $processingCount ?? 0 }}</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-3xl font-bold text-lime-400">{{ $completedCount ?? 0 }}</p>
                </div>
            </div>
